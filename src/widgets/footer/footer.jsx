  ...
  return (
    <footer className={style.footer}>
        ...
        <div className={style.footer__wrapper}>
          <div className={style.footer__left}>
            ...
            <p className={style.information}>
              Информация 1932-{currentYear} г. Министерство образования, науки и молодежи Государственное бюджетное профессиональное образовательное учреждение Республики Крым  «Симферопольский политехнический колледж имени князя Л.С. Голицына»
            </p>
      ...
      <div className={style.footer__copyright}>
        © {currentYear} Министерство образования, науки и молодежи Государственное бюджетное профессиональное образовательное учреждение Республики Крым  «Симферопольский политехнический колледж имени князя Л.С. Голицына»
      </div>
    </footer>
  );
};
